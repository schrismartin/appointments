...
extension Color {
  ...
  public static var inactiveForeground = Color(red: 14 / 255, green: 20 / 255, blue: 44 / 255).opacity(0.48)
  public static var inactiveBackground = Color(red: 0.055, green: 0.078, blue: 0.173).opacity(0.16)
}
